...
$sql = "SELECT c.id_categoria, c.nombre_categoria, sc.id_subcategoria, sc.nombre_subcategoria,ma.id_marca,ma.nombre_marca,ma.estado
FROM categoria c
...
ORDER BY  sc.nombre_subcategoria, ma.nombre_marca";
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                if ($row_marca['estado'] == 1) {
                                    echo "<a href='editar_marca.php?id=" . $row_marca['id_marca'] . "' class='btn btn-info mx-3'>Editar</a>";

                                    echo "<a href='../crud/estado_marca.php?id=" . $row_marca['id_marca'] . "&estado=0' class='btn btn-danger'>Desactivar</a>";
                                } else {
                                    echo "<a href='../crud/estado_marca.php?id=" . $row_marca['id_marca'] . "&estado=1' class='btn btn-success'>Activar</a>";
                                }
                                ?>
                            </td>
                        </tr>
